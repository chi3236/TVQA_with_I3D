...
# def build_graph(FLAGS, vocab_embedding, flow_input, sub, q, a0, a1, a2, a3, a4, a, qid, sub_seq_len,
...
def build_graph(FLAGS, vocab_embedding, flow_input, sub, q, a0, a1, a2, a3, a4, a, qid, sub_seq_len,
    ...
    with tf.variable_scope("prediction"):
        ...
        for v in tf.trainable_variables():
            if v.name.startswith(u"Flow") or v.name.startswith(u"video") or v.name.startswith(
                    u"Text") or v.name.startswith(u"post_rnn"):
