...
def build_graph(FLAGS, sub, q, a0, a1, a2, a3, a4, a, qid, sub_seq_len, q_seq_len, a0_seq_len, a1_seq_len, a2_seq_len, a3_seq_len, a4_seq_len, is_training):
    ...
    #with tf.device("/GPU:2"):
        ...
        with tf.variable_scope("Text_GRU", reuse=tf.AUTO_REUSE):
            ...
            question_rnn_logits = question_rnn_model.build(q, is_training=is_training, seq_len=q_seq_len)
            subtitle_rnn_logits = subtitle_rnn_model.build(sub, is_training=is_training, seq_len=sub_seq_len)
            answer0_rnn_logits = answer_rnn_model.build(a0, is_training=is_training, seq_len=a0_seq_len)
            answer1_rnn_logits = answer_rnn_model.build(a1, is_training=is_training, seq_len=a1_seq_len)
            answer2_rnn_logits = answer_rnn_model.build(a2, is_training=is_training, seq_len=a2_seq_len)
            answer3_rnn_logits = answer_rnn_model.build(a3, is_training=is_training, seq_len=a3_seq_len)
            answer4_rnn_logits = answer_rnn_model.build(a4, is_training=is_training, seq_len=a4_seq_len)
